...
1. Use the MAP prior that you fitted to all the historical control trials in Practical 2 to help design a new study.
 ...
 a. Use a standard sample size calculation (Lecture 6 slide 13 or proc power) to calculate the sample size for a new study ignoring the historical data to have 80% power and 5% type 1 error rate, and assuming that the control treatment has a 22% failure chance and the experimental treatment has a 15% failure chance 
