#'  Prior effective sample size ESS for Beta-mixture priors based on Morita, Thall, Mueller (2008, Biometrics) evaluated at mode
#'
#' @param mixture A mixture.prior object
#' @param c  factor such that Beta( mu/c , (1-mu)/c ) is noninformative, where mu is mode of prior
